  ...
  useEffect(() => {
    async function fetchTastyDetail(id) {
      ...
      if (tastyDetail.mapx && tastyDetail.mapy) {
        ...
        if (container) {
          const options = {
            center: new window.kakao.maps.LatLng(tastyDetail.mapx, tastyDetail.mapy),
            level: 3
          };
          const map = new window.kakao.maps.Map(container, options);
          const markerPosition = new window.kakao.maps.LatLng(tastyDetail.mapx, tastyDetail.mapy);
